...
export PATH=$HOME/bin:/usr/local/bin:$PATH:$HOME/MyProject/bin:$HOME/GoPath/bin
export GOPATH=$HOME/GoPath:$HOME/MyProject
...
alias mvim="/usr/local/Cellar/macvim/7.4-84/bin/mvim"
